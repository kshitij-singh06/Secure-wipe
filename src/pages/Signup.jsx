      ...
      <div className="container">
        <div style={{ maxWidth: '400px', margin: '0 auto', background: 'white', padding: '2rem', borderRadius: '1rem', border: '1px solid #E5E7EB', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1)' }}>
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <h2 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '0.5rem' }}>Create Account</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500', color: '#374151' }}>
                Product Key <span style={{ color: '#DC2626' }}>*</span>
              </label>
              <div style={{ position: 'relative' }}>
                <Key size={18} style={{ position: 'absolute', left: '0.75rem', top: '50%', transform: 'translateY(-50%)', color: '#9CA3AF' }} />
                <input
                  type="text"
                  name="productKey"
          ...
          <div style={{ textAlign: 'center', color: '#6B7280' }}>
            ...
            <Link to="/login" style={{ color: '#1DB954', textDecoration: 'none', fontWeight: '500' }}>
              Sign in
            </Link>
          </div>
        </div>
